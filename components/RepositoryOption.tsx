...
export function RepositoryOption(props: RepositoryOptionType) {
  const { name, query, svn_url, url, full_name, language, stargazers_count, open_issues_count, forks_count, owner } = props;
      ...
      {({ active }) => (
        <>
          <header className="flex items-center">
            ...
            {/* <span className="ml-1 font-bold flex-auto truncate">{{highlightMatchedText(name, query)}}</span> */}
          </header>
